...
typedef struct {
	...
	T4POINT area;			// contact area (location) relative to panel. includes any text description
...
struct TPANEL {
	...
	T2POINT *itemOffset;	// offset each and every image location by T2POINT:x/y
