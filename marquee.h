...
#define MARQUEE_WRAP	0x04		/* not implemented */

#define MARQUEE_TOTAL	64



typedef struct{
	char line[MAX_PATH_UTF8+1];	// text to display
	uint64_t time;				// display until this time is reached
	int flags;					// per line render flags
}TMARQUEELINE;
...
int marqueeDraw (TVLCPLAYER *vp, TFRAME *frame, TMARQUEE *mq, int x, int y);
